...
var currentTime = setInterval(function(){
	...
	time.textContent = addZero(hours) + ":" + addZero(minutes) + ":" + addZero(seconds) + "" + ampm;
...
setInterval(function(){
	...
	var currentTime = time.textContent = addZero(hours) + ":" + addZero(minutes) + ":" + addZero(seconds) + "" + ampm;
